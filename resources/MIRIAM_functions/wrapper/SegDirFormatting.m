...
if isunix   %if mac use '/'
    ...
    if ~exist([SlideDir '/SegQuant/CellShape'], 'dir')
      ...
      if ~exist([SlideDir '/SegQuant/Annotated'], 'dir')
        mkdir([SlideDir '/SegQuant/Annotated']);
    end
    ...
    OutDir{18}=[SlideDir '/SegQuant/Annotated/'];

function CellSegQuant_CellDive_thresh(SlideDir, quantify, shape, stroma, tumor, start, ilastik_epi_file, ilastik_mem_file, ilastik_app_loc, stack_markers)
    ...
    if stroma==1 && quantify ==1
        ...
        if  ~exist(join([OutDir{13} 'StrPosStats_' OutPos{i} '.csv'],""), 'file')
            ...
            if tumor==1
                ...
                strStats=MxIF_quantify_stroma3_threshold(i, water, AFRemoved, AFList, PosList,ThreshList, NUCimg,  tumorMask, OutPos);

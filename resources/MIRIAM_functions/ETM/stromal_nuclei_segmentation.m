function B=stromal_nuclei_segmentation(image)
% Eliot McKinley
% 11-14-2018
% This function takes a nuclear probability file from machine learning and
% segments stromal nuclei

%based upon the function relased by naive on MathWorks File Excchange
%https://www.mathworks.com/matlabcentral/fileexchange/45174-nuclei-counter
...
%image=sourceImage=imread('/Users/etmckinley/Dropbox (VUMC)/scan_alpha/TCPS4A/SegQuant/Stacks/str_000_stack_Probabilities.png');
%image=sourceImage=sourceImage(:,:,1);
